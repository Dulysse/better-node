...
namespace Tx {
  namespace String {
    ...
    */
    type Split<T extends string, S=""> = S extends string ? _StringSplit<T, S> : never;
    /**
     * @from `@dulysse1/better-node`
    ...
    */
      type LastIndexOf<T extends string, S extends string> = _StringLastIndexOf<T, S>;
    /**
     * @from `@dulysse1/better-node`
    ...
    */
    type Replace<T extends string, From extends string, To extends string> = _StringReplace<T, From, To>;
    /**
     * @from `@dulysse1/better-node`
     ...
     * @returns {string} The string updated 
    */
    type ReplaceAll<T extends string, From extends string, To extends string> = _StringReplaceAll<T, From, To>;
    /**
     * @from `@dulysse1/better-node`
     * ### Reverse a string
     * @example 
    ...
    */
    type Slice<T extends string, Start=0, End=Length<T>> = _StringSlice<T, Start, End>;
  }
}